...
// 1️⃣ MANEJO DE FORMULARIO: crear o editar
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($accion === 'crear') {
        ...
        updateUser($_POST['id'], $usuario, $nombre, $apellido, $correo, $contrasena, $tipo, $estado);
    }
...
<body>
    ...
    <br>
    <a href="../public/Panel.php">🏠 Volver </a> |
    <a href="../public/cerrarsesion.php">🚪 Cerrar sesión</a>
</body>
</html>